...
В веб-консоли на `http://localhost:8091` на карточке разворачиваемой головы вместо
кнопки видна полоса с фазой ("проверяю веса", "скачиваю N%", "запускаю движок"), кнопки
остальных голов на это время выключены, а строки движка идут в «Логах».
